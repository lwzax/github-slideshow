...
public class MyMVCconfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/identify.html").setViewName("identify");
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginHandlerInterceptor()).addPathPatterns("/**").excludePathPatterns("/signin.html","/","/login","/css/**","/img/**","/font/**","/js/**");
    }
}
